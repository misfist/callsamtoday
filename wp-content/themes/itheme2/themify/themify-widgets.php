...
class Themify_Social_Links extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			<?php echo sprintf(__('<small>Manage links at <a href="%s">Themify</a> > Settings > Social Links.</small>', 'themify'), admin_url('admin.php?page=themify#setting')); ?>
		</p>
		<?php
	}
}
	...
	class Themify_Twitter extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			echo do_shortcode("[themify-twitter username='$username' show_count='$show_count' show_timestamp='$hide_timestamp' show_follow='$show_follow' follow_text='$follow_text' include_retweets='$include_retweets' is_widget='true']");
