...
function themify_shortcodes_js_css(){
	...
	//Register Twitter Script
	wp_register_script( 'jtweets', THEMIFY_URI . '/js/jquery.jtweetsanywhere-1.3.1.min.js', array('jquery'), false, true );
...
function themify_shortcode_twitter($atts, $content = null) {
	...
	$out = '<div class="twitter-list '.$is_shortcode.' twitter-block-'.$themify_twitter_instance.'" >';
	...
	$out .= "<script type='text/javascript'>
			jQuery(document).ready(function(){
				jQuery('.twitter-block-".$themify_twitter_instance."').jTweetsAnywhere({
					username: '$username',
					count: $show_count,
					showTweetFeed: {
